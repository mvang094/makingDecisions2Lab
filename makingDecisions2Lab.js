...
/*
  Determine if the letter grade of the given variable 'score'. If the variable is a 90 or above, console log an 'A', between 80 and 89, console log a 'B', between 70 and 79, 'C', between 60 and 69, 'D', 
...
let lengths = myFavoriteNumbers.length;

if (lengths < 7)
  console.log("There are not enough elements in this array");
else{
  someNum = myFavoriteNumbers[6]; //6 because remember, arrays start at index of 0
  console.log(someNum)};
...
for (let i = 4; i > -1; i--) //you can also do i >= 0
...
switch (letterGrade){
  case 'A':
  console.log("The student is doing excellently. Grade is " + letterGrade);
  break;
  case 'B':
  console.log("The student is doing well. Grade is " + letterGrade);
  break;
  case 'C':
  console.log("The student is doing alright. Grade is " + letterGrade);
  break;
  case 'D': 
  console.log("The student is not doing very well. Grade is", letterGrade);
  break;
  case 'F': 
  console.log("The student is failing. Grade is", letterGrade);
  break;
  default:
